          ...
          {mainProjects.length !== 0 && (
            <>
              <Row xs={1} md={2} lg={3} className="g-4 justify-content-center">
                ...
                <Col key={123}>
                      <StyledCard
                        name={"cat-vs-dog-classifier-kunal"}
                        url={"https://gitlab.com/deep-learning-kunal/cat-vs-dog-classifier-kunal"}
                        gitlab={"true"}
                        demo = {"https://cat-dog-classifier-kunal.onrender.com/"}
                      />
                </Col>
                <Col key={124}>
                      <StyledCard
                        name={"quote_generator_lstm"}
                        url={"https://gitlab.com/deep-learning-kunal/quote_generator_lstm"}
                        gitlab={"true"}
                        demo = {"https://quote-generator-lstm-kunal.onrender.com/"}
                      />
                </Col>
              </Row>
              {data.length > 3 && (
